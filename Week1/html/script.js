...
//  Conditionals are a symbolic syntax that takes two variables, values , strings etc and manipulates them
//      to the developers desired effect using appropriate syntax, variables can be used to store the result of conditionals.
//
//      + Adds values
//      - Subtracts values
//      / Divides values
